...
async function getImage(num){
    let JSONdata = await getSatData("1247942400","1549065600","5d093aa46dae90003461d1d9","cda3de7380c305987a9346a110328670");
    let IMGurl = JSONdata[num]['image']['truecolor'].substring(29);
    let options;
    console.log(IMGurl);
    options = {
    ...
    let request = http.get(options, function(res){
        ...
        res.on('end', function(){
            fs.writeFile('SatImage2.png', imagedata, 'binary', function(err){
                if (err) throw err
